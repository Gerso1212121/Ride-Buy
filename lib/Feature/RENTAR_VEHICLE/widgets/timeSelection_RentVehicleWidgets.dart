...
class OptimizedTimeSelectionRentVehicleWidgets extends StatefulWidget {
  ...
  @override
  State<OptimizedTimeSelectionRentVehicleWidgets> createState() =>
      _OptimizedTimeSelectionRentVehicleWidgetsState();
}

class _OptimizedTimeSelectionRentVehicleWidgetsState
    extends State<OptimizedTimeSelectionRentVehicleWidgets> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                isSelected ? const Color(0xFF2563EB) : const Color(0xFFD1D5DB),
            width: 1,
          ),
        ),
        child: Text(
