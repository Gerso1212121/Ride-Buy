import 'package:ezride/Feature/Favoritos/widgets/FavoritosCard_widget.dart';
...
class _FavCardsState extends State<FavCards> {
  ...
  final List<VehicleItem> _favoriteVehicles = [
    VehicleItem(
      id: '1',
      imageUrl: 'https://images.unsplash.com/photo-1704146705694-6bab0ffb8cf9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NTk3Mjk3Nzd8&ixlib=rb-4.1.0&q=80&w=1080',
      title: 'BMW Serie 3',
    ...
    VehicleItem(
      id: '2',
      imageUrl: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?ixlib=rb-4.0.0&auto=format&fit=crop&w=1080&q=80',
      title: 'Audi A4',
      subtitle: '2023 • Sedán • Automático',
    ...
    VehicleItem(
      id: '3',
      imageUrl: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?ixlib=rb-4.0.0&auto=format&fit=crop&w=1080&q=80',
    ...
    VehicleItem(
      id: '4',
      imageUrl: 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?ixlib=rb-4.0.0&auto=format&fit=crop&w=1080&q=80',
      title: 'Tesla Model 3',
  ...
  void _handleClearAll() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('¿Estás seguro de que quieres eliminar todos tus vehículos favoritos?'),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Todos los favoritos han sido eliminados')),
              );
            },
            style: TextButton.styleFrom(
              foregroundColor: Theme.of(context).colorScheme.error,
