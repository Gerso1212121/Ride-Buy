...
import 'widgets/VehicleDetail_AppBar_widget.dart';
import 'widgets/VehicleDetail_Description_widget.dart';
import 'widgets/VehicleDetail_Features_widget.dart';
import 'widgets/VehicleDetail_CardInfo_widget.dart';
import 'widgets/VehicleDetail_Info_widget.dart';
import 'widgets/VehicleDetail_BackgroundImage_widget.dart';
import 'widgets/VehicleDetail_Title_widget.dart';
...
class _VehicleDetailScreenState extends State<VehicleDetailScreen> {
  ...
  final Map<String, dynamic> _vehicleData = {
    ...
    'description': 'El BMW X5 2024 combina lujo y rendimiento en un SUV premium. Con su diseño elegante y tecnología de vanguardia, ofrece una experiencia de conducción excepcional. Equipado con un motor turbocharged de 6 cilindros y transmisión automática de 8 velocidades, proporciona un rendimiento suave y potente.',
    'features': [
  ...
  void _onRentPressed() {
    ...
    print('Rent vehicle: ${_vehicleData['title']}');
        ...
        children: [
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: ParajaxCardetailwidgets(
          ...
          Positioned(
            ...
            child: AppBarCarDetailwidgets(
              ...
              favoriteButtonColor: Colors.black54,
              showShadow: false,
            ),
          ),
