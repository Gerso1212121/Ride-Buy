...
import 'package:ezride/Feature/HOME/controller/Home_Controller.dart';
import 'package:ezride/Feature/HOME/widgets/Home_Promo_widget.dart';
import 'package:ezride/Core/widgets/Heads/section_header_HomeWidgets.dart';
import 'package:ezride/Feature/HOME/widgets/Home_CardCars_widget.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _featuredVehicles = [
    {
      'imageUrl': 'https://images.unsplash.com/photo-1731988666788-6f0251886c1b',
      'title': 'BMW X5 2024',
  ...
  Widget _buildVehicleCardWithPlaceholder(Map<String, dynamic> vehicle, {required VoidCallback onTap}) {
    return VehicleCard(
  ...
  void _preloadCriticalImages() async {
    try {
      final bannerImage = NetworkImage('https://images.unsplash.com/photo-1727547082307-84ec9e300f9a');
  ...
  void _onVehicleTap(Map<String, dynamic> vehicle) {
    print('Vehicle tapped: ${vehicle['title']}');
  }
